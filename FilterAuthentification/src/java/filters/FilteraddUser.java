 ...
 * @author 1795162
 */
public class FilteraddUser implements Filter {
    ...
    public FilteraddUser() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FilteraddUser:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FilteraddUser:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("FilteraddUser:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FilteraddUser()");
        }
        StringBuffer sb = new StringBuffer("FilteraddUser(");
